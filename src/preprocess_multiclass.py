...
XToClassify = pd.read_csv('../multiclass/XtoClassify.csv', header=None)
df['y'] = y
...
XToClassify = full_pipeline.fit_transform(XToClassify)
...
np.savetxt("../prepared_data/multiclass/XToClassify.txt", XToClassify)
